...
def conversion(sheroes: list):
    ...
    with open("sheroes_conversion.txt", "w") as a:
        ...
        for x in sheroes:
            ...
            response = requests.get(f'https://abcd2.projectabcd.com/api/getinfo.php?id={x}',
            ...
            # loop through to remove any newline characters or carriage returns
            while True:
                if "\r\n" in description:
            ...
            completion = client.chat.completions.create(
                ...
                messages=[
                    ...
                    {"role": "system",
                     "content": "You are translating third person descriptions of famous Indian women into first person scripts with the same reading complexity level."},
